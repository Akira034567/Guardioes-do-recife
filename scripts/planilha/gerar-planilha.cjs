...
const decisoes = [
  ...
  [6, "Peixe-Pedra: calibrar o ciclo novo", "A V3.2 trocou a armadilha de uso único pelo emboscador recorrente: 3s de recarga, bote comprometido e zona na borda da correnteza. Os números passaram na simulação, mas nunca foram jogados à mão.", "Ver se 3s de recarga não o deixa forte demais em rota estreita, e se a zona de 54 do ramo B não é pequena demais para acertar alguém."],
];
