...
export const GUARDIANS: Record<GuardianId, GuardianDefinition> = {
  ...
  stonefish: {
    ...
    description: `Armadilha na rota: leva ${seconds(stonefish.trap.armMs)} para se enterrar e emerge com ${stonefish.trap.damage} de dano. Não dispara no primeiro contato — espera o grupo e sai pouco antes de o primeiro escapar do raio. Recarga ${seconds(stonefish.trap.cooldownMs)}.`,
    role: "Armadilha",
    color: 0x8a7a55,
    accent: 0xffd166,
    cost: stonefish.cost,
    ...
    branches: [
      ...
      },
      {
        ...
        upgrades: [
          ...
          {
            name: "Fúria Abissal",
            description: `Explode com ${stonefish.ambush.level2.damage} de dano, ${seconds(stonefish.ambush.level2.stun.durationMs)} de stun e empurra ${stonefish.ambush.level2.knockback.distance}px para trás na rota. Chefes: só stun reduzido.`,
            cost: stonefish.upgradeCosts[1],
            trap: {
              ...stonefish.trap,
