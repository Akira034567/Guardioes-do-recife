...
export const RECIFE_THREE: LevelDefinition = {
  ...
  enemyScaling: { health: 1.1, speed: 1, reward: 1 },
  waypoints: [
    { x: 180, y: 30 },
    { x: 180, y: 140 },
    { x: 240, y: 220 },
  ...
  waves: [
    {
      name: "Sondagem",
      groups: [
        { enemyId: "swimmer", count: 8, intervalMs: 800, delayMs: 0 },
    ...
    },
    {
      name: "Agulhas",
      groups: [
        { enemyId: "needlefish", count: 6, intervalMs: 700, delayMs: 0 },
    ...
    },
    {
      name: "Muralha",
      groups: [
        { enemyId: "shellback", count: 4, intervalMs: 1600, delayMs: 0 },
        { enemyId: "swimmer", count: 6, intervalMs: 800, delayMs: 2000 },
      ],
    },
    {
      name: "A Moreia",
      groups: [
        ...
        { enemyId: "dartfish", count: 5, intervalMs: 700, delayMs: 5000 },
      ],
    },
    {
      name: "Agulhas e Cascos",
      groups: [
        { enemyId: "needlefish", count: 8, intervalMs: 600, delayMs: 0 },
        { enemyId: "shellback", count: 3, intervalMs: 1700, delayMs: 2500 },
      ],
    },
    {
      name: "Duas Moreias",
      groups: [
        ...
        { enemyId: "swimmer", count: 8, intervalMs: 750, delayMs: 1500 },
        { enemyId: "needlefish", count: 5, intervalMs: 650, delayMs: 7000 },
      ],
    },
    {
      ...
      groups: [
        ...
        { enemyId: "moray", count: 1, intervalMs: 1000, delayMs: 5000 },
        { enemyId: "shellback", count: 3, intervalMs: 1500, delayMs: 8000 },
      ],
    },
  ],
};
