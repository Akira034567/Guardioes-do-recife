...
export const RECIFE_FIVE: LevelDefinition = {
  ...
  enemyScaling: { health: 1.3, speed: 1.05, reward: 1 },
  waypoints: [
    { x: -40, y: 540 },
    { x: 120, y: 540 },
    { x: 230, y: 480 },
  ...
  waves: [
    ...
    },
    {
      ...
      groups: [
        { enemyId: "needlefish", count: 8, intervalMs: 550, delayMs: 0 },
        { enemyId: "moray", count: 1, intervalMs: 1000, delayMs: 3000 },
        { enemyId: "shellback", count: 3, intervalMs: 1500, delayMs: 5000 },
      ],
    },
    {
      name: "Blindagem Pesada",
      groups: [
        { enemyId: "shellback", count: 6, intervalMs: 1200, delayMs: 0 },
        { enemyId: "minnow", count: 14, intervalMs: 220, delayMs: 2500 },
    ...
    },
    {
      ...
      groups: [
        ...
        { enemyId: "dartfish", count: 8, intervalMs: 600, delayMs: 3000 },
        { enemyId: "needlefish", count: 6, intervalMs: 600, delayMs: 8000 },
      ],
    },
    {
      ...
      groups: [
        ...
        { enemyId: "swimmer", count: 8, intervalMs: 650, delayMs: 2000 },
        { enemyId: "shellback", count: 3, intervalMs: 1500, delayMs: 6000 },
      ],
    },
    {
      name: "Três Moreias",
      groups: [
        { enemyId: "moray", count: 3, intervalMs: 3500, delayMs: 0 },
        { enemyId: "needlefish", count: 8, intervalMs: 550, delayMs: 1500 },
        { enemyId: "shellback", count: 4, intervalMs: 1400, delayMs: 6000 },
      ],
    },
    {
      name: "Tempestade",
      groups: [
        { enemyId: "dartfish", count: 10, intervalMs: 500, delayMs: 0 },
        { enemyId: "minnow", count: 16, intervalMs: 210, delayMs: 2000 },
        { enemyId: "shellback", count: 5, intervalMs: 1300, delayMs: 4500 },
    ...
    },
    {
      ...
      groups: [
        ...
        { enemyId: "tidebreaker", count: 1, intervalMs: 1000, delayMs: 4000 },
        { enemyId: "shellback", count: 4, intervalMs: 1300, delayMs: 7000 },
        { enemyId: "needlefish", count: 8, intervalMs: 500, delayMs: 12000 },
        { enemyId: "minnow", count: 12, intervalMs: 220, delayMs: 15000 },
      ],
    },
  ],
};
